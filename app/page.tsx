...
const Page = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-[90vh] lg:h-[100vh] ">
      <div className="">
      ...
      <div className="w-full lg:w-5/6 h-[90vh] lg:h-[100vh] flex flex-col overflow-hidden bg-gray-900 rounded-lg shadow-lg">
        {/* Messages Container */}
